...
public class DeadlockSupport {
    ...
    private final static Logger LOG = 
        LoggerFactory.getLogger(DeadlockSupport.class);
    ...
    public static void startDeadlockMonitoring() {
        final Thread t = new DaemonThread(new Runnable() {
            public void run() {
                while(true) {
                    try {
